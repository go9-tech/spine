...
@Getter
@Setter
public class UnexpectedException extends RuntimeException implements ManagedException {
	...
	public UnexpectedException(String status, String bundle, String code, Optional<Object> meta) {
	...
	public UnexpectedException(String status, String bundle, String code, Optional<Object> meta, Object... args) {
	...
	public UnexpectedException(String status, String bundle, String code, Optional<Object> meta, Throwable cause) {
